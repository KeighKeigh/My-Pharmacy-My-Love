...
namespace ELIXIR.API.Controllers.INVENTORY_CONTROLLER
{
    ...
    public class InventoryController : BaseApiController
    {
        ...
        [HttpGet("ElixirPharmacyMRP/{itemcode}")]
        public async Task<IActionResult> MRPInventoryWithItemCode([FromRoute] string itemcode)
        {
            var inventory = await _unitOfWork.Inventory.GetAllItemForInventoryWithItemCode(itemcode);
